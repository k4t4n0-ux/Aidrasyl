...
const baseConjuros = {
    ...
    "Alarma": {
        ...
        duracion: "8 horas",
        efecto: [
            "Estableces una alarma contra intrusiones. Elige una puerta, ventana o área dentro del alcance que no sea más grande de un cubo de 6 metros. Hasta que el hechizo termine, una alarma te alerta siempre que una criatura toque o entre en el área protegida. Cuando lanzas el hechizo, puedes designar criaturas que no activen la alarma. También eliges si la alarma es audible o mental.",
            "Alarma audible: La alarma produce el sonido de una campana de mano durante 10 segundos dentro de 18 metros del área protegida.",
            "Alarma mental: Eres alertado por un ping mental si estás dentro de 1.6 kilómetros del área protegida. Este ping te despierta si estás durmiendo."
        ]
    },
    ...
    "Brazos de Hadar": {
        ...
        duracion: "Instantáneo",
        efecto: [
            "Invocando a Hadar, haces que zarcillos broten de ti. Cada criatura en una emanación de 3 metros originada desde ti realiza una tirada de salvación de Fuerza. Si falla, una criatura recibe daño necrótico 2d6 y no puede tomar Reacciones hasta el inicio de su siguiente turno. Si tiene éxito, una criatura recibe la mitad del daño."
        ],
        escalado: {
    ...
    "Manos ardientes": {
        ...
        duracion: "Instantáneo",
        efecto: [
            "Una fina lámina de llamas brota de ti. Cada criatura en un cono de 4.5 metros realiza una tirada de salvación de Destreza, recibiendo daño de fuego 3d6 si falla o la mitad si tiene éxito.",
    ...
    "Orbe cromático": {
        ...
        efecto: [
            ...
            "Si sacas el mismo número en dos o más d8, el orbe salta a un objetivo diferente de tu elección dentro de 9 metros del objetivo. Realiza una tirada de ataque contra el nuevo objetivo, y haz una nueva tirada de daño."
        ],
        escalado: {
    ...
    "Lluvia de color": {
        ...
        duracion: "Instantáneo",
        efecto: [
            "Lanzas un deslumbrante despliegue de luz intermitente y colorida. Cada criatura en un cono de 4.5 metros originado desde ti debe tener éxito en una tirada de salvación de Constitución o tener la condición Cegado hasta el final de tu siguiente turno."
        ]
    },
    ...
    "Orden": {
        ...
        efecto: [
            ...
            "Acerca. El objetivo se mueve hacia ti por la ruta más corta y directa, terminando su turno si se mueve dentro de 1.5 metros de ti.",
    ...
    "Duelo obligado": {
        ...
        duracion: "Concentración, hasta 1 minuto",
        efecto: [
            "Intentas obligar a una criatura a un duelo. Una criatura que puedas ver dentro del alcance realiza una tirada de salvación de Sabiduría. Si falla, el objetivo tiene Desventaja en tiradas de ataque contra criaturas que no sean tú, y no puede moverse voluntariamente a un espacio que esté más de 9 metros lejos de ti.",
            "El hechizo termina si realizas una tirada de ataque contra una criatura que no sea el objetivo, si lanzas un hechizo en un enemigo que no sea el objetivo, si un aliado tuyo daña el objetivo, o si terminas tu turno más de 9 metros lejos del objetivo."
        ]
    },
    ...
    "Crear o destruir agua": {
        ...
        efecto: [
            ...
            "Crear agua: Creas hasta 40 litros de agua limpia dentro del alcance en un recipiente abierto. Alternativamente, el agua cae como lluvia en un cubo de 9 metros dentro del alcance, extinguiendo las llamas expuestas allí.",
            "Destruir agua: Destruyes hasta 40 litros de agua en un recipiente abierto dentro del alcance. Alternativamente, destruyes la niebla en un cubo de 9 metros dentro del alcance."
        ],
        escalado: {
            efecto: "Creas o destruyes 40 litros adicionales de agua, o el tamaño del cubo aumenta 1.5 metros, para cada nivel de espacio de hechizo superior a 1."
        }
    },
    ...
    "Detectar el mal y el bien": {
        ...
        efecto: [
            "Durante la duración, sientes la ubicación de cualquier Aberración, Celestial, Elemental, Feérico, Demonio o No-muerto dentro de 9 metros de ti. También sientes si el hechizo Consagración está activo allí y, si es así, dónde.",
            "El hechizo está bloqueado por 0.3 metros de piedra, tierra o madera; 2.5 centímetros de metal; o una fina lámina de plomo."
        ]
    },
    ...
    "Detectar veneno y enfermedad": {
        ...
        duracion: "Concentración, hasta 10 minutos",
        efecto: [
            "Durante la duración, sientes la ubicación de venenos, criaturas venenosas o ponzoñosas, y contagios mágicos dentro de 9 metros de ti. Sientes el tipo de veneno, criatura o contagio en cada caso.",
            "El hechizo está bloqueado por 0.3 metros de piedra, tierra o madera; 2.5 centímetros de metal; o una fina lámina de plomo."
        ]
    },
    ...
    "Enredar": {
        ...
        duracion: "Concentración, hasta 1 minuto",
        efecto: [
            "Plantas agarradoras brotan del suelo en un cuadrado de 6 metros dentro del alcance. Durante la duración, estas plantas convierten el terreno en el área en Terreno difícil. Desaparecen cuando el hechizo termina.",
    ...
    "Caída de pluma": {
        ...
        escuela: "Transmutación",
        tipo: "neutro",
        tiempo: "Reacción, que realizas cuando tú o una criatura que puedas ver dentro de 18 metros de ti cae",
        rango: "18p",
        componentes: "V, M (una pequeña pluma o trozo de plumón)",
        duracion: "1 minuto",
        efecto: [
            "Elige hasta cinco criaturas cayendo dentro del alcance. La velocidad de descenso de una criatura se ralentiza a 18 metros por ronda hasta que el hechizo termine. Si una criatura aterriza antes de que el hechizo termine, la criatura no recibe daño de la caída, y el hechizo termina para esa criatura."
        ]
    },
    ...
    "Encontrar familiar": {
        ...
        efecto: [
            ...
            "Conexión telepática: Mientras tu familiar esté dentro de 30 metros de ti, puedes comunicarte con él telepáticamente. Además, como tal, Acción adicional, puedes ver a través de los ojos del familiar y escuchar lo que escucha hasta el inicio de tu siguiente turno.",
            ...
            "Desaparición del familiar: Cuando el familiar cae a 0 Puntos de Golpe, desaparece. Reaparece después de que lances este hechizo de nuevo. Como una acción de Magia, puedes despedir temporalmente el familiar a una dimensión bolsillo. Alternativamente, puedes despedirlo para siempre. Como una acción de Magia mientras está despedido temporalmente, puedes hacer que reaparezca en un espacio desocupado dentro de 9 metros de ti."
        ]
    },
    ...
    "Nube de niebla": {
        ...
        efecto: [
            "Creas una esfera de radio 6 metros de niebla centrada en un punto dentro del alcance. La esfera está Fuertemente oscurecida. Dura durante la duración o hasta que un fuerte viento disperse la niebla."
        ],
        escalado: {
            efecto: "El radio de la niebla aumenta 6 metros para cada nivel de espacio de hechizo superior a 1."
        }
    },
    ...
    "Grasa": {
        ...
        duracion: "1 minuto",
        efecto: [
            "Una grasa inflamable cubre el suelo en un cuadrado de 3 metros centrado en un punto dentro del alcance y lo convierte en Terreno difícil durante la duración.",
    ...
    "Granizo de espinas": {
        ...
        duracion: "Instantáneo",
        efecto: [
            "Mientras golpeas la criatura, este hechizo crea una lluvia de espinas que brota de tu arma a distancia o munición. El objetivo del ataque y cada criatura dentro de 1.5 metros de él realizan una tirada de salvación de Destreza, recibiendo daño perforante 1d10 si falla o la mitad si tiene éxito."
        ],
        escalado: {
    ...
    "Represalia infernal": {
        ...
        escuela: "Evocación",
        tipo: "salvacion",
        tiempo: "Reacción, que realizas en respuesta a recibir daño de una criatura que puedas ver dentro de 18 metros de ti",
        rango: "18p",
        componentes: "V, S",
        duracion: "Instantáneo",
        efecto: [
    ...
    "Escritura ilusoria": {
        ...
        duracion: "10 días",
        efecto: [
            "Escribes en pergamino, papel u otro material adecuado e imbuyes el hechizo con una ilusión que dura durante la duración. Para ti y cualquier criatura que designes cuando lances el hechizo, la escritura parece normal, parece estar escrita en tu mano, y transmite el significado que pretendías cuando escribiste el texto. Para todos los demás, la escritura aparece como si estuviera escrita en un guión desconocido o mágico que es ininteligible. Alternativamente, la ilusión puede alterar el significado, la letra manuscrita y el idioma del texto.",
            "Si el hechizo se disipa, tanto la escritura original como la ilusión desaparecen.",
            "Una criatura que tiene Visión verdadera puede leer el mensaje oculto."
        ]
    },
    ...
    "Salto": {
        ...
        duracion: "1 minuto",
        efecto: [
            "Tocas una criatura dispuesta. Una vez en cada uno de sus turnos hasta que el hechizo termine, esa criatura puede saltar hasta 9 metros gastando 3 metros de movimiento."
        ],
        escalado: {
            efecto: "Puedes apuntar a una criatura adicional para cada nivel de espacio de hechizo superior a 1."
        }
    ...
    "Paso largo": {
        ...
        duracion: "1 hora",
        efecto: [
            "Tocas una criatura. La velocidad del objetivo aumenta 3 metros hasta que el hechizo termine."
        ],
        escalado: {
            efecto: "Puedes apuntar a una criatura adicional para cada nivel de espacio de hechizo superior a 1."
        }
    ...
    "Purificar comida y bebida": {
        ...
        duracion: "Instantáneo",
        efecto: [
            "Eliminas veneno y podredumbre de comida y bebida no mágica en una esfera de radio 1.5 metros centrada en un punto dentro del alcance."
        ]
    },
    ...
    "Imagen silenciosa": {
        ...
        duracion: "Concentración, hasta 10 minutos",
        efecto: [
            "Creas la imagen de un objeto, una criatura o algún otro fenómeno visible que no sea más grande de un cubo de 4.5 metros. La imagen aparece en un punto dentro del alcance y dura durante la duración. La imagen es puramente visual; no va acompañada de sonido, olor u otros efectos sensoriales.",
    ...
    "Dormir": {
        ...
        duracion: "Concentración, hasta 1 minuto",
        efecto: [
            "Cada criatura de tu elección en una esfera de radio 1.5 metros centrada en un punto dentro del alcance debe tener éxito en una tirada de salvación de Sabiduría o tener la condición Incapacitada hasta el final de su siguiente turno, momento en el cual debe repetir la salvación. Si el objetivo falla la segunda salvación, el objetivo tiene la condición Inconsciente durante la duración. El hechizo termina en un objetivo si recibe daño o alguien dentro de 1.5 metros de él toma una acción para sacudirlo.",
    ...
    "Disco flotante de Tenser": {
        ...
        duracion: "1 hora",
        efecto: [
            "Este hechizo crea un plano circular y horizontal de fuerza, de 1 metro de diámetro, que flota 1 metro por encima del suelo en un espacio desocupado de tu elección que puedas ver dentro del alcance. El disco permanece durante la duración y puede sostener hasta 227 kilogramos. Si se coloca más peso, el hechizo termina y todo en el disco cae al suelo.",
            "El disco es inmóvil mientras estés dentro de 6 metros de él. Si te alejas más de 6 metros, el disco te sigue para permanecer dentro de 6 metros de ti. Puede atravesar terreno desigual, subir o bajar escaleras pero no puede cruzar un cambio de elevación de más de 3 metros.",
            "Si te alejas más de 30 metros del disco, el hechizo termina."
        ]
    },
    ...
    "Golpe de trueno": {
        ...
        duracion: "Instantáneo",
        efecto: [
            "Tu golpe suena con trueno que es audible dentro de 90 metros de ti, y el objetivo recibe daño adicional 2d6 de trueno del ataque. Además, si el objetivo es una criatura, debe tener éxito en una tirada de salvación de Fuerza o ser empujado 3 metros lejos de ti y tener la condición Tendida."
        ],
        escalado: {
            efecto: "El daño aumenta en 1d6 para cada nivel de espacio de hechizo superior a 1."
        }
    ...
    "Onda de trueno": {
        ...
        duracion: "Instantáneo",
        efecto: [
            "Desatas una onda de energía de trueno. Cada criatura en un cubo de 4.5 metros originado desde ti realiza una tirada de salvación de Constitución. Si falla, una criatura recibe daño de trueno 2d8 y es empujada 3 metros lejos de ti. Si tiene éxito, una criatura recibe la mitad del daño.",
            "Además, los objetos no asegurados que están completamente dentro del cubo son empujados 3 metros lejos de ti, y un sonido ensordecedor es audible dentro de 90 metros."
        ],
        escalado: {
            efecto: "El daño aumenta en 1d8 para cada nivel de espacio de hechizo superior a 1."
        }
    ...
    "Sirviente invisible": {
        ...
        efecto: [
            ...
            "Una vez en cada uno de tus turnos como una Acción adicional, puedes dar comandos mentalmente al sirviente para que se mueva hasta 4.5 metros e interactúe con un objeto. El sirviente puede realizar tareas simples que un humano podría hacer, como traer cosas, limpiar, reparar, doblar ropa, encender fuegos, servir comida y verter bebidas."
        ]
    },
    ...
    "Cerradura Arcana": {
        ...
        efecto: [
            "Tocas una puerta, ventana, puerta, contenedor u escotilla cerrada y la cierras mágicamente durante la duración. Esta cerradura no puede ser abierta por ningún medio no mágico. Tú y cualquier criatura que designes cuando lances el hechizo puedes abrir y cerrar el objeto a pesar de la cerradura. También puedes establecer una contraseña que, cuando se hable dentro de 1.5 metros del objeto, lo desbloquee durante 1 minuto."
        ]
    },
    ...
    "Augurio": {
        ...
        duracion: "Instantáneo",
        efecto: [
            "Recibes un presagio de una entidad de otro mundo sobre los resultados de un curso de acción que planeas tomar dentro de los próximos 30 minutos. El DJ elige el presagio de una tabla de presagios (Bueno, Malo, Bueno y Malo, o Indiferencia).",
    ...
    "Calmar Emociones": {
        ...
        duracion: "Concentración, hasta 1 minuto",
        efecto: [
            "Cada Humanoide en una Esfera de radio 6 metros centrada en un punto que elijas dentro del alcance debe tener éxito en una tirada de salvación de Carisma o ser afectado por uno de los siguientes efectos (tú eliges para cada criatura):",
    ...
    "Llama perpetua": {
        ...
        duracion: "Hasta que sea disipado",
        efecto: [
            "Una llama brota de un objeto que tocas. El efecto emite Luz brillante en un radio de 6 metros y Luz tenue para 6 metros adicionales. Se ve como una llama normal, pero no crea calor y no consume combustible. La llama puede ser cubierta u ocultada pero no sofocada ni extinguida."
        ]
    },
    ...
    "Cordón de flechas": {
        ...
        duracion: "8 horas",
        efecto: [
            "Tocas hasta cuatro Flechas o Pernos no mágicos y los plantas en el suelo en tu espacio. Hasta que el hechizo termine, la munición no puede ser arrancada físicamente. Siempre que una criatura que no seas tú entra en un espacio dentro de 9 metros de la munición por primera vez en un turno o termina su turno allí, un proyectil vuela hacia arriba para golpearlo. La criatura debe tener éxito en una tirada de salvación de Destreza o recibir daño perforante 2d4. El proyectil es entonces destruido. El hechizo termina cuando ninguna munición permanece plantada en el suelo. Cuando lanzas este hechizo, puedes designar criaturas que elijas, e el hechizo las ignora."
        ],
        escalado: {
    ...
    "Oscuridad": {
        ...
        duracion: "Concentración, hasta 10 minutos",
        efecto: [
            "Durante la duración, la Oscuridad mágica se extiende desde un punto dentro del alcance y llena una Esfera de radio 4.5 metros. Visión en la Oscuridad no puede ver a través de ella, y la luz no mágica no puede iluminarla.",
            "Alternativamente, lanzas el hechizo en un objeto que no está siendo llevado o portado, causando que la Oscuridad llene una Emanación de 4.5 metros originada desde ese objeto. Cubrir ese objeto con algo opaco, como un cuenco o casco, bloquea la Oscuridad.",
    ...
    "Visión en la oscuridad": {
        ...
        duracion: "8 horas",
        efecto: [
            "Durante la duración, una criatura dispuesta que tocas tiene Visión en la Oscuridad con un alcance de 45 metros."
        ]
    },
    ...
    "Armadura de muerte": {
        ...
        duracion: "1 hora",
        efecto: [
            "Durante la duración, un aura tintada rodea una criatura que tocas. El objetivo tiene Ventaja en tiradas de salvación de muerte, y una vez por turno, cuando una criatura dentro de 1.5 metros del objetivo lo golpea con una tirada de ataque de combate, el atacante recibe daño necrótico 2d4."
        ]
    },
    ...
    "Hoja de fuego": {
        ...
        efecto: [
            ...
            "La hoja en llamas emite Luz brillante en un radio de 3 metros y Luz tenue para 3 metros adicionales."
        ],
        escalado: {
            efecto: "El daño aumenta en 1d6 para cada nivel de espacio de hechizo superior a 2."
        }
    ...
    "Esfera ardiente": {
        ...
        duracion: "Concentración, hasta 1 minuto",
        efecto: [
            "Creas una esfera de fuego de 1.5 metros de diámetro en un espacio desocupado en el suelo dentro del alcance. Dura durante la duración. Cualquier criatura que termine su turno dentro de 1.5 metros de la esfera realiza una tirada de salvación de Destreza, recibiendo daño de fuego 2d6 si falla o la mitad si tiene éxito.",
            "Como una Acción adicional, puedes mover la esfera hasta 9 metros, rodándola por el suelo. Si mueves la esfera hacia el espacio de una criatura, esa criatura realiza la salvación contra la esfera, y la esfera deja de moverse ese turno.",
            "Cuando mueves la esfera, puedes dirigirla sobre barreras de hasta 1.5 metros de altura y saltarla sobre fosos de hasta 3 metros de ancho. Los objetos inflamables que no están siendo llevados o portados comienzan a arder si son tocados por la esfera, y emite Luz brillante en un radio de 6 metros y Luz tenue para 6 metros adicionales."
        ],
        escalado: {
            efecto: "El daño aumenta en 1d6 para cada nivel de espacio de hechizo superior a 2."
        }
    ...
    "Ráfaga de viento": {
        ...
        duracion: "Concentración, hasta 1 minuto",
        efecto: [
            "Una Línea de viento fuerte de 18 metros de largo y 3 metros de ancho sopla desde ti en una dirección que elijas durante la duración. Cada criatura en la Línea debe tener éxito en una tirada de salvación de Fuerza o ser empujada 4.5 metros lejos de ti en una dirección siguiendo la Línea. Una criatura que termina su turno en la Línea debe hacer la misma salvación.",
            "Cualquier criatura en la Línea debe gastar 0.6 metros de movimiento por cada 0.3 metros que se mueve cuando se mueve más cerca de ti.",
    ...
    "Llamar": {
        ...
        efecto: [
            ...
            "Cuando lanzas el hechizo, un golpe fuerte, audible hasta 90 metros de distancia, emana del objetivo."
        ]
    },
    ...
    "Levitar": {
        ...
        duracion: "Concentración, hasta 10 minutos",
        efecto: [
            "Una criatura u objeto suelto de tu elección que puedas ver dentro del alcance se eleva verticalmente hasta 6 metros y permanece suspendida allí durante la duración. El hechizo puede levitar un objeto que pesa hasta 227 kilogramos. Una criatura que no es dispuesta que tiene éxito en una tirada de salvación de Constitución no es afectada.",
            "El objetivo solo puede moverse empujando o jalando contra un objeto fijo o superficie dentro del alcance (como una pared o techo), lo cual le permite moverse como si estuviera trepando. Puedes cambiar la altitud del objetivo hasta 6 metros en cualquier dirección en tu turno. Si eres el objetivo, puedes moverte hacia arriba o hacia abajo como parte de tu movimiento. De otra manera, puedes tomar una Acción de Magia para mover el objetivo, que debe permanecer dentro del alcance del hechizo.",
    ...
    "Localizar animales o plantas": {
        ...
        duracion: "Instantáneo",
        efecto: [
            "Describe o nombra un tipo específico de Bestia, criatura Planta, o planta no mágica. Aprendes la dirección y distancia a la criatura o planta más cercana de ese tipo dentro de 8 kilómetros, si alguna está presente."
        ]
    },
    ...
    "Localizar objeto": {
        ...
        duracion: "Concentración, hasta 10 minutos",
        efecto: [
            "Describe o nombra un objeto que te es familiar. Sientes la dirección hacia la ubicación del objeto si ese objeto está dentro de 300 metros de ti. Si el objeto está en movimiento, sabes la dirección de su movimiento.",
            "El hechizo puede localizar un objeto específico que conoces si lo has visto de cerca (dentro de 9 metros) al menos una vez. Alternativamente, el hechizo puede localizar el objeto más cercano de un tipo particular, como cierto tipo de atuendo, joyería, muebles, herramienta, o arma.",
    ...
    "Boca mágica": {
        ...
        efecto: [
            ...
            "El disparador puede ser tan general o detallado como desees, aunque debe basarse en condiciones visuales o audibles que ocurren dentro de 9 metros del objeto. Por ejemplo, podrías instruir a la boca para hablar cuando cualquier criatura se mueve dentro de 9 metros del objeto o cuando una campana de plata suena dentro de 9 metros de él."
        ]
    },
    ...
    "Paso neblinoso": {
        ...
        duracion: "Instantáneo",
        efecto: [
            "Brevemente rodeado de neblina plateada, te teletransportas hasta 9 metros a un espacio desocupado que puedas ver."
        ]
    },
    ...
    "Rayo lunar": {
        ...
        duracion: "Concentración, hasta 1 minuto",
        efecto: [
            "Un rayo de apariencia pálida brilla hacia abajo en un Cilindro de radio 1.5 metros y 12 metros de alto centrado en un punto dentro del alcance. Hasta que el hechizo termine, Luz tenue llena el Cilindro, y puedes tomar una Acción de Magia en turnos posteriores para mover el Cilindro hasta 18 metros.",
    ...
    "Pasar sin dejar rastro": {
        ...
        duracion: "Concentración, hasta 1 hora",
        efecto: [
            "Irradias un aura de ocultación en una Emanación de 9 metros durante la duración. Mientras estén en el aura, tú y cada criatura que elijas tienen un bonificación +10 a pruebas de Destreza (Sigilo) y no dejan rastros."
        ]
    },
    ...
    "Fuerza fantasmal": {
        ...
        efecto: [
            ...
            "Un objetivo afectado puede incluso recibir daño de la ilusión si el fantasma representa una criatura o peligro peligroso. En cada uno de tus turnos, tal fantasma puede infligir daño psíquico 2d8 al objetivo si está en el área del fantasma o dentro de 1.5 metros del fantasma. El objetivo percibe el daño como un tipo apropiado para la ilusión."
        ]
    },
    ...
    "Truco de cuerda": {
        ...
        duracion: "1 hora",
        efecto: [
            "Tocas una cuerda. Un extremo de ella flota hacia arriba hasta que la cuerda cuelga perpendicular al suelo o la cuerda alcanza un techo. En el extremo superior de la cuerda, un portal Invisible de 0.9 metros por 1.5 metros se abre a un espacio extradimensional que dura hasta que el hechizo termine. Ese espacio puede ser alcanzado trepando la cuerda, que puede ser jalada hacia adentro o dejada caer de él.",
    ...
    "Destrozo": {
        ...
        duracion: "Instantáneo",
        efecto: [
            "Un ruido fuerte estalla desde un punto de tu elección dentro del alcance. Cada criatura en una Esfera de radio 3 metros centrada allí realiza una tirada de salvación de Constitución, recibiendo daño de trueno 3d8 si falla o la mitad si tiene éxito. Un Constructo tiene Desventaja en la salvación.",
    ...
    "Golpe brillante": {
        ...
        duracion: "Concentración, hasta 1 minuto",
        efecto: [
            "El objetivo golpeado por el golpe recibe daño radiante adicional 2d6 del ataque. Hasta que el hechizo termine, el objetivo emite Luz brillante en un radio de 1.5 metros, las tiradas de ataque contra él tienen Ventaja, y no puede beneficiarse de la condición Invisible."
        ],
        escalado: {
            efecto: "El daño aumenta en 1d6 para cada nivel de espacio de hechizo superior a 2."
        }
    ...
    "Crecimiento de púas": {
        ...
        duracion: "Concentración, hasta 10 minutos",
        efecto: [
            "El suelo en una Esfera de radio 6 metros centrada en un punto dentro del alcance brota púas duras y espinas. El área se convierte en Terreno difícil durante la duración. Cuando una criatura se mueve hacia adentro o dentro del área, recibe daño perforante 2d4 por cada 1.5 metros que viaja.",
    ...
    "Arma espiritual": {
        ...
        duracion: "Concentración, hasta 1 minuto",
        efecto: [
            "Creas una fuerza espectral y flotante que semeja un arma de tu elección y dura durante la duración. La fuerza aparece dentro del alcance en un espacio de tu elección, y puedes inmediatamente hacer un ataque de hechizo de combate contra una criatura dentro de 1.5 metros de la fuerza. En un golpe, el objetivo recibe daño de fuerza igual a 1d8 más tu modificador de habilidad de lanzamiento de hechizos.",
            "Como una Acción adicional en tus turnos posteriores, puedes mover la fuerza hasta 6 metros y repetir el ataque contra una criatura dentro de 1.5 metros de ella."
        ],
        escalado: {
            efecto: "El daño aumenta en 1d8 para cada nivel de espacio de hechizo superior a 2."
        }
    ...
    "Telaraña": {
        ...
        duracion: "Concentración, hasta 1 hora",
        efecto: [
            "Conjuras una masa de pegajosa telaraña en un punto dentro del alcance. Las telarañas llenan un Cubo de 6 metros allí durante la duración. Las telarañas son Terreno difícil, y el área dentro de ellas está Levemente Oscurecida.",
            "Si las telarañas no están ancladas entre dos masas sólidas (como paredes o árboles) o colocadas en capas en el piso, pared o techo, la telaraña se colapsa en sí misma, y el hechizo termina al inicio de tu siguiente turno. Telarañas colocadas en capas sobre una superficie plana tienen una profundidad de 1.5 metros.",
            ...
            "Las telarañas son inflamables. Cualquier Cubo de 1.5 metros de telarañas expuesto al fuego se quema en 1 ronda, infligiendo daño de fuego 2d4 a cualquier criatura que comience su turno en el fuego."
        ]
    },
    ...
    "Muertos animados": {
        ...
        efecto: [
            ...
            "En cada uno de tus turnos, puedes tomar una Acción adicional para ordenar mentalmente a cualquier criatura que hayas creado con este hechizo si la criatura está dentro de 18 metros de ti. Decides qué acción realizará la criatura y dónde se moverá en su siguiente turno, o puedes emitir un comando general, como guardar una cámara o pasillo. Si no emites comandos, la criatura toma la acción Esquivar y se mueve solo para evitar daño.",
    ...
    "Aura de vitalidad": {
        ...
        duracion: "Concentración, hasta 1 minuto",
        efecto: [
            "Un aura irradia desde ti en una Emanación de 9 metros durante la duración. Cuando creas el aura y al inicio de cada uno de tus turnos mientras persiste, puedes restaurar 2d6 Puntos de Golpe a una criatura en él."
        ]
    },
    ...
    "Llamada de rayo": {
        ...
        duracion: "Concentración, hasta 10 minutos",
        efecto: [
            "Una nube de tormenta aparece en un punto dentro del alcance que puedas ver por encima de ti. Toma la forma de un Cilindro que es 3 metros alto con un radio de 18 metros.",
            "Cuando lanzas el hechizo, elige un punto que puedas ver bajo la nube. Un rayo dispara desde la nube hacia ese punto. Cada criatura dentro de 1.5 metros de ese punto realiza una tirada de salvación de Destreza, recibiendo daño de rayo 3d10 si falla o la mitad si tiene éxito.",
    ...
    "Convocar animales": {
        ...
        efecto: [
            ...
            "Tienes Ventaja en tiradas de salvación de Fuerza mientras estés dentro de 1.5 metros de la manada, y cuando te mueves en tu turno, también puedes mover la manada hasta 9 metros a un espacio desocupado que puedas ver.",
            "Siempre que la manada se mueva dentro de 3 metros de una criatura que puedas ver y siempre que una criatura que puedas ver entra en un espacio dentro de 3 metros de la manada o termina su turno allí, puedes forzar a esa criatura a realizar una tirada de salvación de Destreza. Si falla, la criatura recibe daño cortante 3d10. Una criatura realiza esta salvación solo una vez por turno."
        ],
        escalado: {
            efecto: "El daño aumenta en 1d10 para cada nivel de espacio de hechizo superior a 3."
        }
    ...
    "Convocar constructos": {
        ...
        efecto: [
            ...
            "Cuando lanzas este hechizo y como acción de Magia en turnos posteriores, puedes ordenar a los espíritus que apunten a una criatura u objeto que puedas ver dentro de 1.5 metros de los espíritus y crear uno de los siguientes efectos:",
            ...
            "Cuando te mueves en tu turno, también puedes mover los espíritus hasta 9 metros a un espacio desocupado que puedas ver."
        ],
        escalado: {
    ...
    "Capa del cruzado": {
        ...
        duracion: "Concentración, hasta 1 minuto",
        efecto: [
            "Irradias un aura mágica en una Emanación de 9 metros. Mientras estén en el aura, tú y tus aliados infliges daño radiante adicional 1d4 al golpear con un arma o un ataque desarmado."
        ]
    },
    ...
    "Luz del día": {
        ...
        duracion: "1 hora",
        efecto: [
            "Durante la duración, la luz solar se extiende desde un punto dentro del alcance y llena una Esfera de radio 18 metros. El área de luz solar es Luz brillante y emite Luz tenue para 18 metros adicionales.",
            "Alternativamente, lanzas el hechizo en un objeto que no está siendo llevado o portado, causando que la luz solar llene una Emanación de 18 metros originada desde ese objeto. Cubrir ese objeto con algo opaco, como un recipiente o casco, bloquea la luz solar.",
    ...
    "Miedo": {
        ...
        duracion: "Concentración, hasta 1 minuto",
        efecto: [
            "Cada criatura en un cono de 9 metros debe tener éxito en una tirada de salvación de Sabiduría o soltar lo que está sosteniendo y tener la condición Asustada durante la duración.",
    ...
    "Volar": {
        ...
        duracion: "Concentración, hasta 10 minutos",
        efecto: [
            "Tocas una criatura dispuesta. Durante la duración, el objetivo gana una Velocidad de vuelo de 18 metros y puede cernerse. Cuando el hechizo termina, el objetivo cae si todavía está en el aire a menos que pueda detener la caída."
        ],
        escalado: {
    ...
    "Glifo de protección": {
        ...
        efecto: [
            ...
            "Runa explosiva. Cuando se activa, el glifo estalla con energía mágica en una Esfera de radio 6 metros centrada en el glifo. Cada criatura en el área realiza una tirada de salvación de Destreza. Una criatura recibe daño de Ácido, Frío, Fuego, Rayo o Trueno (tu elección cuando creas el glifo) 5d8 si falla o la mitad si tiene éxito.",
    ...
    "Patrón hipnótico": {
        ...
        duracion: "Concentración, hasta 1 minuto",
        efecto: [
            "Creas un patrón ondulante de colores en un Cubo de 9 metros dentro del alcance. El patrón aparece un momento y desaparece. Cada criatura en el área que pueda ver el patrón debe tener éxito en una tirada de salvación de Sabiduría o tener la condición Encantada durante la duración. Mientras está Encantada, la criatura tiene la condición Incapacitada y una Velocidad de 0.",
    ...
    "Lanza plateada de Laeral": {
        ...
        duracion: "Instantáneo",
        efecto: [
            "Energía plateada estalla desde ti en una Línea de 36 metros de largo y 1.5 metros de ancho. Cada criatura de tu elección en la Línea realiza una tirada de salvación de Fuerza. Si falla, una criatura recibe daño de fuerza 3d10 y tiene la condición Tendida. Si tiene éxito, una criatura recibe la mitad del daño."
        ],
        escalado: {
            efecto: "El daño aumenta en 1d10 para cada nivel de espacio de hechizo superior a 3."
        }
    ...
    "Choza diminuta de Leomund": {
        ...
        duracion: "8 horas",
        efecto: [
            "Una Emanación de 3 metros surge en existencia alrededor de ti y permanece estacionaria durante la duración. El hechizo falla cuando lo lanzas si la Emanación no es lo suficientemente grande para encapsular completamente a todas las criaturas en su área.",
    ...
    "Flecha de rayo": {
        ...
        duracion: "Instantáneo",
        efecto: [
            "Conforme tu ataque golpea o falla el objetivo, el arma o munición que estás usando se transforma en un rayo. En lugar de tomar daño u otros efectos del ataque, el objetivo recibe daño de rayo 4d8 si golpea o la mitad si falla. Cada criatura dentro de 3 metros del objetivo realiza una tirada de salvación de Destreza, recibiendo daño de rayo 2d8 si falla o la mitad si tiene éxito.",
    ...
    "Rayo de rayo": {
        ...
        duracion: "Instantáneo",
        efecto: [
            "Un rayo de rayo formando una Línea de 30 metros de largo y 1.5 metros de ancho estalla desde ti en una dirección que elijas. Cada criatura en la Línea realiza una tirada de salvación de Destreza, recibiendo daño de rayo 8d6 si falla o la mitad si tiene éxito."
        ],
        escalado: {
            efecto: "El daño aumenta en 1d6 para cada nivel de espacio de hechizo superior a 3."
        }
    ...
    "Círculo mágico": {
        ...
        duracion: "1 hora",
        efecto: [
            "Creas un Cilindro de energía mágica de radio 3 metros y 6 metros de alto centrado en un punto en el suelo que puedas ver dentro del alcance. Runas brillantes aparecen donde el Cilindro se intersecta con el piso u otra superficie.",
    ...
    "Imagen mayor": {
        ...
        duracion: "Concentración, hasta 10 minutos",
        efecto: [
            "Creas la imagen de un objeto, una criatura o algún otro fenómeno visible que no sea más grande de un Cubo de 6 metros. La imagen aparece en un punto que puedas ver dentro del alcance y dura durante la duración. Parece real, incluyendo sonidos, olores y temperatura apropiados a lo que se representa, pero no puede infligir daño o causar condiciones.",
    ...
    "Fusionarse con la piedra": {
        ...
        efecto: [
            ...
            "Mientras estés fusionado con la piedra, no puedes ver lo que ocurre fuera de ella, y cualquier prueba de Sabiduría (Percepción) que realices para escuchar sonidos fuera de ella se realiza con Desventaja. Permaneces consciente del paso del tiempo y puedes lanzar hechizos en ti mismo mientras estés fusionado en la piedra. Puedes usar 1.5 metros de movimiento para salir de la piedra donde entraste, lo que termina el hechizo. De otra manera no puedes moverte.",
    ...
    "Caballo fantasma": {
        ...
        duracion: "1 hora",
        efecto: [
            "Una criatura Grande, cuasireal, similar a un caballo aparece en el suelo en un espacio desocupado de tu elección dentro del alcance. Decides la apariencia de la criatura, y está equipada con una silla de montar, freno y brida. Cualquier equipo creado por el hechizo desaparece en una nube de humo si es llevado más de 3 metros lejos del caballo.",
            "Durante la duración, tú o una criatura que elijas pueden montar el caballo. El caballo usa el bloque de estadísticas del Caballo de montar (ve el Apéndice B), excepto que tiene una Velocidad de 30 metros y puede viajar 20 kilómetros en una hora. Cuando el hechizo termina, el caballo gradualmente se desvanece, dando al jinete 1 minuto para desmontar. El hechizo termina anticipadamente si el caballo recibe daño."
        ]
    },
    ...
    "Crecimiento de plantas": {
        ...
        efecto: [
            ...
            "Sobrecrecimiento. Elige un punto dentro del alcance. Todas las plantas normales en una Esfera de radio 30 metros centrada en ese punto se vuelven espesas y sobrecrecidas. Una criatura moviéndose a través de esa área debe gastar 1.2 metros de movimiento por cada 0.3 metros que se mueve. Puedes excluir una o más áreas de cualquier tamaño dentro del área del hechizo de ser afectadas.",
    ...
    "Tormenta de granizo": {
        ...
        duracion: "Concentración, hasta 1 minuto",
        efecto: [
            "Hasta que el hechizo termine, caen granizos en un Cilindro de 12 metros de alto y radio 6 metros centrado en un punto que elijas dentro del alcance. El área está Muy Oscurecida, y las llamas expuestas en el área están apagadas.",
    ...
    "Guardianes espirituales": {
        ...
        duracion: "Concentración, hasta 10 minutos",
        efecto: [
            "Espíritus protectores revolotean alrededor de ti en una Emanación de 4.5 metros durante la duración. Si eres bueno o neutral, su forma espectral aparece angélica o feérica (tu elección). Si eres malvado, aparecen demoniaca.",
    ...
    "Nube apestosa": {
        ...
        duracion: "Concentración, hasta 1 minuto",
        efecto: [
            "Creas una Esfera de radio 6 metros de gas amarillo y nauseabundo centrada en un punto dentro del alcance. La nube está Muy Oscurecida. La nube permanece en el aire durante la duración o hasta que un fuerte viento (como el creado por Ráfaga de viento) la dispersa.",
    ...
    "Convocar No-muerto": {
        ...
        tiempo: "Acción",
        rango: "27p",
        componentes: "V, S, M (una calavera dorada que cuesta 300+ MO)",
        duracion: "Concentración, hasta 1 hora",
        efecto: [
            "Convocas un espíritu No-muerto. Se manifiesta en un espacio desocupado que puedas ver dentro del alcance y usa el bloque de estadísticas del Espíritu No-muerto. Cuando lanzas el hechizo, elige la forma de la criatura: Espantos, Pútrida o Esquelética. El espíritu se asemeja a una criatura No-muerta con la forma elegida, que determina ciertos detalles en su bloque de estadísticas. La criatura desaparece cuando cae a 0 Puntos de Golpe o cuando el hechizo termina.",
            "La criatura es un aliado para ti y tus aliados. En combate, la criatura comparte tu contador de Iniciativa, pero toma su turno inmediatamente después del tuyo. Obedece tus comandos verbales (sin acción requerida por ti). Si no emites ninguno, toma la acción Esquivar y usa su movimiento para evitar peligro."
        ],
        escalado: {
            efecto: "Usa el nivel del espacio de hechizo para el nivel del hechizo en el bloque de estadísticas."
    ...
    "Víbora de Sylune": {
        ...
        efecto: [
            ...
            "Morfedura venenosa. Como una acción de Magia, puedes hacer un ataque de hechizo a distancia usando la serpiente contra una criatura dentro de 15 metros. Si golpeas, el objetivo recibe daño de fuerza 1d6 y tiene la condición Envenenada hasta el inicio de tu siguiente turno. Mientras está Envenenada, el objetivo tiene la condición Incapacitada."
        ],
        escalado: {
    ...
    "Muro de viento": {
        ...
        duracion: "Concentración, hasta 1 minuto",
        efecto: [
            "Un muro de viento fuerte se levanta del suelo en un punto que elijas dentro del alcance. Puedes hacer que el muro sea de hasta 15 metros de largo, 4.5 metros de alto y 0.3 metros de grosor. Puedes darle forma al muro de cualquier manera que elijas siempre que haga un camino continuo a lo largo del suelo. El muro dura durante la duración.",
    ...
    "Convocar Aberración": {
        ...
        tiempo: "Acción",
        rango: "90p",
        componentes: "V, S, M (un tentáculo encurtido y un ojo en un frasco con incrustaciones de platino que cuesta 400+ MO)",
        duracion: "Concentración, hasta 1 hora",
        efecto: [
            "Invocas un espíritu aberrante. Se manifiesta en un espacio desocupado que puedas ver dentro del alcance y usa el bloque de estadísticas del Espíritu Aberrante. Cuando lanzas el hechizo, elige Parentela de Beholder, Devorador de Mentes, o Slaad. La criatura se asemeja a una Aberración de ese tipo, que determina ciertos detalles en su bloque de estadísticas. La criatura desaparece cuando cae a 0 Puntos de Golpe o cuando el hechizo termina.",
            "La criatura es un aliado para ti y tus aliados. En combate, la criatura comparte tu contador de Iniciativa, pero toma su turno inmediatamente después del tuyo. Obedece tus comandos verbales (sin acción requerida por ti). Si no emites ninguno, toma la acción Esquivar y usa su movimiento para evitar peligro."
        ],
        escalado: {
            efecto: "Usa el nivel del espacio de hechizo para el nivel del hechizo en el bloque de estadísticas."
    ...
    "Convocar Constructo": {
        ...
        tiempo: "Acción",
        rango: "90p",
        componentes: "V, S, M (una caja de seguridad que cuesta 400+ MO)",
        duracion: "Concentración, hasta 1 hora",
        efecto: [
            "Invocas el espíritu de un Constructo. Se manifiesta en un espacio desocupado que puedas ver dentro del alcance y usa el bloque de estadísticas del Espíritu Constructo. Cuando lanzas el hechizo, elige un material: Arcilla, Metal o Piedra. La criatura se asemeja a una estatua animada (tú determinas la apariencia) hecha del material elegido, que determina ciertos detalles en su bloque de estadísticas. La criatura desaparece cuando cae a 0 Puntos de Golpe o cuando el hechizo termina.",
            "La criatura es un aliado para ti y tus aliados. En combate, la criatura comparte tu contador de Iniciativa, pero toma su turno inmediatamente después del tuyo. Obedece tus comandos verbales (sin acción requerida por ti). Si no emites ninguno, toma la acción Esquivar y usa su movimiento para evitar peligro."
        ],
        escalado: {
            efecto: "Usa el nivel del espacio de hechizo para el nivel del hechizo en el bloque de estadísticas."
    ...
    "Convocar Elemental": {
        ...
        tiempo: "Acción",
        rango: "90p",
        componentes: "V, S, M (aire, una piedrecilla, ceniza y agua dentro de un frasco con incrustaciones de oro que cuesta 400+ MO)",
        duracion: "Concentración, hasta 1 hora",
        efecto: [
            "Invocas un espíritu Elemental. Se manifiesta en un espacio desocupado que puedas ver dentro del alcance y usa el bloque de estadísticas del Espíritu Elemental. Cuando lanzas el hechizo, elige un elemento: Aire, Tierra, Fuego o Agua. La criatura se asemeja a una forma bípeda envuelta en el elemento elegido, que determina ciertos detalles en su bloque de estadísticas. La criatura desaparece cuando cae a 0 Puntos de Golpe o cuando el hechizo termina.",
            "La criatura es un aliado para ti y tus aliados. En combate, la criatura comparte tu contador de Iniciativa, pero toma su turno inmediatamente después del tuyo. Obedece tus comandos verbales (sin acción requerida por ti). Si no emites ninguno, toma la acción Esquivar y usa su movimiento para evitar peligro."
        ],
        escalado: {
            efecto: "Usa el nivel del espacio de hechizo para el nivel del hechizo en el bloque de estadísticas."
    ...
    "Convocar Celestial": {
        ...
        duracion: "Concentración, hasta 1 hora",
        efecto: [
            "Convocas un espíritu Celestial. Se manifiesta en una forma angélica en un espacio desocupado que puedas ver dentro del alcance. Cuando lanzas el hechizo, elige Vengador o Defensor. Tu elección determina ciertos detalles en su bloque de estadísticas. La criatura desaparece cuando cae a 0 Puntos de Golpe o cuando el hechizo termina.",
            "La criatura es un aliado para ti y tus aliados. En combate, la criatura comparte tu contador de Iniciativa, pero toma su turno inmediatamente después del tuyo. Obedece tus comandos verbales (sin acción requerida por ti). Si no emites ninguno, toma la acción Esquivar y usa su movimiento para evitar peligro."
        ]
    },
    ...
    "Convocar Dragón": {
        ...
        duracion: "Concentración, hasta 1 hora",
        efecto: [
            "Convocas un espíritu Dragón. Se manifiesta en un espacio desocupado que puedas ver dentro del alcance. La criatura desaparece cuando cae a 0 Puntos de Golpe o cuando el hechizo termina.",
            "La criatura es un aliado para ti y tus aliados. En combate, la criatura comparte tu contador de Iniciativa, pero toma su turno inmediatamente después del tuyo. Obedece tus comandos verbales (sin acción requerida por ti). Si no emites ninguno, toma la acción Esquivar y usa su movimiento para evitar peligro."
        ]
    },
    ...
    "Convocar Demonio": {
        ...
        tiempo: "Acción",
        rango: "90p",
        componentes: "V, S, M (un frasco sangriento que cuesta 600+ MO)",
        duracion: "Concentración, hasta 1 hora",
        efecto: [
            "Llamas a un espíritu demoníaco. Se manifiesta en un espacio desocupado que puedas ver dentro del alcance. Cuando lanzas el hechizo, elige Demonio, Demonio o Yugoloth. La criatura se asemeja a un Demonio del tipo elegido. La criatura desaparece cuando cae a 0 Puntos de Golpe o cuando el hechizo termina.",
            "La criatura es un aliado para ti y tus aliados. En combate, la criatura comparte tu contador de Iniciativa, pero toma su turno inmediatamente después del tuyo. Obedece tus comandos verbales. Si no emites ninguno, toma la acción Esquivar."
        ],
        escalado: {
            efecto: "Usa el nivel del espacio de hechizo para el nivel del hechizo en el bloque de estadísticas."
        }
