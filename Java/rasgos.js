document.addEventListener("DOMContentLoaded", function () {
    ...
    const rasgosClases = {
        artificiero: {
            ...
            2: {
                "Réplica de objeto mágico":"Cuando obtenga esta función, elija cuatro planes para aprender de la tabla Planes de elementos mágicos (nivel de artífice 2+). Siempre que obtenga un nivel de Artífice, puede reemplazar uno de los planes que conoce con un nuevo plan para el cual califica. Aprende otro plan de su elección cuando alcanzaz los niveles de Artificiero 6, 10, 14, 18, como se muestra en la columna Planes conocidos de la tabla Características del Artífice. Cuando eliges un plan para aprender, lo eliges de cualquier tabla de Planes de elementos mágicos para la que califiques.",
                "":"Cuando terminas un descanso largo, puedes crear uno o dos objetos mágicos diferentes si tienes las herramientas de Tinker en la mano. Cada elemento se basa en uno de los planes que conoce para esta función. Si un elemento creado requiere Sintonización, puedes sintonizarte con él en el instante en que lo creas. Si decide sintonizar el elemento más adelante, debe hacerlo utilizando el proceso normal de Sintonización. Cuando alcanza ciertos niveles de Artífice especificados en la columna Elementos mágicos de la tabla Características del Artífice, la cantidad de objetos mágicos que puede crear al final de un Descanso prolongado aumenta. Cada elemento que cree debe basarse en un plan diferente que conozca. No puedes tener más objetos mágicos de esta función que el número que se muestra en la columna Objetos mágicos de la tabla Funciones del artífice para tu nivel. Si intentas exceder tu número máximo de objetos mágicos para esta función, el elemento más antiguo desaparece y luego aparece el nuevo elemento.",
                "":"Un objeto mágico creado por esta característica funciona como el objeto mágico normal, excepto que su magia no es permanente; cuando mueres, el objeto mágico desaparece después de 1d4 días. Si reemplazas un plan que conoces con un plan nuevo, cualquier elemento mágico creado con el plan reemplazado desaparece inmediatamente. Si un elemento que creó con esta función es un contenedor, como una bolsa de sujeción, y desaparece, su contenido aparece inofensivamente dentro y alrededor de su espacio.",
                "":"Puedes usar cualquier Varita o Arma creada por esta función como enfoque de lanzamiento de hechizos en lugar de usar un conjunto de herramientas de artesano.",
                "Planes de artículos mágicos":"Objeto mágico común que no es una poción, un pergamino o una maldición (puedes aprender esta opción varias veces y debes seleccionar un elemento diferente cada vez; cada elemento seleccionado cuenta como un plan diferente). Jarra de alquimia. Bolsa de Holding. Tapa de respiración de agua. Gafas de noche. Herramienta múltiple (requiere sintonía). Disparo repetido (requiere sintonía). Arma que regresa. Cuerda de escalada. Envío de piedras. Escudo +1. Varita de Detección Mágica. Varita de secretos. Varita del Mago de Guerra +1 (requiere sintonía). Arma +1. Envolturas de poder desarmado +1.",
            },
            4: {
            ...
            7: {
                "Flash de genio":"Cuando usted o una criatura que puede ver a menos de 30 pies de usted falla una verificación de habilidad o un lanzamiento de salvación, puede tomar una reacción para agregar una bonificación a la tirada, lo que podría provocar que tenga éxito. La bonificación es igual a tu modificador de Inteligencia (mínimo de +1). Puedes tomar esta Reacción un número de veces igual a tu modificador de Inteligencia (mínimo de una vez). Recuperas todos los usos gastados cuando terminas un descanso largo.",
            },
            10: {
                "Planes de artículos mágicos":"Artículo maravilloso poco común que no está maldito (puedes aprender esta opción varias veces y debes seleccionar un elemento diferente cada vez; cada elemento seleccionado cuenta como un plan diferente). Armadura de Resistencia. Daga del veneno. Cadena élfica. Anillo de plumas cayendo. Anillo de salto. Anillo de blindaje mental. Escudo +2. Varita del Mago de Guerra +2. Arma +2. Envolturas de poder desarmado +2.",
                "Adepto al artículo mágico":"Ahora puedes sintonizar hasta cuatro objetos mágicos a la vez.",
            },
            11: {
                "Artículo para almacenar hechizos":"Cada vez que terminas un Descanso Largo, puedes tocar un arma simple o marcial o un elemento que puedes usar como enfoque de lanzamiento de hechizos, y guardas un hechizo en él, eligiendo un hechizo Artífice de nivel 1, 2 o 3 que tenga un lanzamiento. tiempo de una acción y no requiere un componente Material que sea consumido por el hechizo (no es necesario tener el hechizo preparado). Mientras sostiene el objeto, una criatura puede realizar una acción mágica para producir el efecto del hechizo a partir de él, utilizando su modificador de habilidad de lanzamiento de hechizos. Si el hechizo requiere Concentración, la criatura debe concentrarse. Una vez que una criatura ha usado el objeto para producir el efecto del hechizo, el objeto no puede usarse de esta manera nuevamente hasta el comienzo del siguiente turno de la criatura. El hechizo permanece en el objeto hasta que se haya usado un número de veces igual al doble de su modificador de Inteligencia (mínimo de dos veces) o hasta que use esta función nuevamente para almacenar un hechizo en un objeto.",
            },
            14: {
                "Planes de artículos mágicos":"Artículo raro y maravilloso que no está maldito (puedes aprender esta opción varias veces y debes seleccionar un elemento diferente cada vez; cada elemento seleccionado cuenta como un plan diferente). Armadura +2. Escudo para atrapar flechas (requiere sintonía). Lengua de llama (requiere sintonía). Anillo de acción libre (requiere sintonía). Anillo de Protección (requiere sintonía). Anillo del carnero (requiere sintonía).",
                "Artículo Avanzado":"Ahora puedes sintonizar hasta cinco objetos mágicos a la vez. Y cuando terminas un descanso corto, recuperas un uso gastado de tu función Flash de genio.",
            },
            18: {
            ...
            20: {
                "Alma del Arte":"Si te reducen a 0 puntos de vida pero no te matan directamente, puedes desintegrar cualquier cantidad de objetos mágicos poco comunes o raros creados por tu función Replicar objeto mágico. Si lo haces, tus puntos de vida cambian a un número igual a 20 veces la cantidad de objetos mágicos desintegrados. Cuando terminas un descanso corto, recuperas todos los usos gastados de tu destello de genio si tienes sintonía con al menos un objeto mágico."
            }
        },
